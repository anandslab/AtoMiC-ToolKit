...
APPPIDFILE=$APPPATH'/couchpotato.pid'
APPDEPS='git libffi-dev libssl-dev zlib1g-dev libxslt1-dev libxml2-dev python python-pip python-dev python-cheetah python-pyasn1 build-essential'
