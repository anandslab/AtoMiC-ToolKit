...
BFILE=$(dialog --title "Restore CouchPotato" --stdout --title "Choose backup file to restore. Use TAB or ARROW keys to move and SPACE to select." --fselect $SCRIPTPATH/backups/ 15 120)
