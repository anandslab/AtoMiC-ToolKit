...
echo -e 'Any existing SickGear files were moved to '$CYAN'/home/'$UNAME'/.sickrage_'`date '+%m-%d-%Y_%H-%M'`$ENDCOLOR
...
chmod 775 -R /home/$UNAME/.sickgear >/dev/null 2>&1
sudo chown $UNAME: /home/$UNAME/.sickgear >/dev/null 2>&1
