...
echo 
echo -e $YELLOW'--->SickGear uninstallation will start soon. Please read the following carefully.'$ENDCOLOR
...
echo -e '5. Best used to uninstall SickGear installed using AtoMiC ToolKit or '$CYAN'www.htpcBeginner.com'$ENDCOLOR' guides.'
...
echo -n 'Type the username of the user you installed SickGear as and press [ENTER]. Typically, this is your system login name (IMPORTANT! Ensure correct spelling and case): '
read UNAME
...
read -p 'Do you want to keep SickGear installation files as a backup or for reinstalling later? Type y/Y to keep files or any other key to delete files, and press [ENTER] : '
FILEDEL=${REPLY,,}
...
echo -e $YELLOW'Thank you for using the AtoMiC SickGear Uninstall script from www.htpcBeginner.com.'$ENDCOLOR 
echo
