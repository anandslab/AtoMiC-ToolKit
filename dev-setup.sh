...
echo -e $YELLOW'17. '$ENDCOLOR'SickGear - Backup Database and Settings '$RED'(test)'$ENDCOLOR
echo -e $YELLOW'18. '$ENDCOLOR'SickGear - Restore Database and Settings '$RED'(test)'$ENDCOLOR
...
echo -e $YELLOW'27. '$ENDCOLOR'CouchPotato - Backup Database and Settings '$RED'(test)'$ENDCOLOR
echo -e $YELLOW'28. '$ENDCOLOR'CouchPotato - Restore Database and Settings '$RED'(test)'$ENDCOLOR
