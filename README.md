...
It takes significant amount of time and effort to develop AtoMiC ToolKit. With the emergence of Docker and Docker compose, setting up a <a href="https://www.smarthomebeginner.com/traefik-reverse-proxy-tutorial-for-docker/">Docker-based media server</a> is now significantly easier. Therefore, over time, our plan is to slowly transition over to <a href-<a href="https://github.com/GhostWriters/DockSTARTer">DockSTARTer</a>, which is an attempt to do what AtoMiC ToolKit does and more using Docker. Development activities on AtoMiC ToolKit may stop eventually. Therefore, we recommend you to start / transition over to DockSTARTer. 
