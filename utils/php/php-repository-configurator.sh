...
case "$CODENAME" in
    ...
    'jessie'|'stretch'|'sid')
        ...
        APPNAME='php7.0'
        APPDEPS='php7.0-cli php7.0-common libapache2-mod-php7.0 php7.0-mysql php7.0-fpm php7.0-curl php7.0-gd php7.0-bz2 php7.0-mcrypt php7.0-json php7.0-tidy php7.0-mbstring php-redis php-memcached'
