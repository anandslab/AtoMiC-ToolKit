...
SUBCHOICE=$(whiptail --title "AtoMiC ToolKit - Manage Lazy Librarian" --menu "What would you like to do?" --backtitle "$BACKTITLE" --fb --cancel-button "Exit" $LINES $COLUMNS $NETLINES \
