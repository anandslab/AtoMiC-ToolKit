...
case "$CODENAME" in
    ...
    *)
        ...
        #APPNAME='php7.1'
        #APPDEPS='php7.1 php7.1-cli php7.1-common libapache2-mod-php7.1 php7.1-mysql php7.1-fpm php7.1-curl php7.1-gd php7.1-bz2 php7.1-mcrypt php7.1-json php7.1-tidy php7.1-mbstring php-redis php-memcached'
