...
echo 
echo -e $YELLOW'--->Sonarr uninstallation will start soon. Please read the following carefully.'$ENDCOLOR
...
echo -e '5. Best used to uninstall Sonarr installed using AtoMiC ToolKit or '$CYAN'www.htpcBeginner.com'$ENDCOLOR' guides.'
...
echo -n 'Type the username of the user you installed Sonarr / NzbDrone as and press [ENTER]. Typically, this is your system login name (IMPORTANT! Ensure correct spelling and case): '
read UNAME
...
echo -e $YELLOW'Thank you for using the AtoMiC Sonarr Uninstall script from www.htpcBeginner.com.'$ENDCOLOR 
echo
